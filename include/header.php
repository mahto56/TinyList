...
<html>
  ...
  <body>
    <div id="header">
      <h1 id="logo"><a href="index.php" id="home"><img src="assets/images/mark.png" alt="logo" />
       ...
       <div class="nav">
         <?php if(strpos($_SERVER['SCRIPT_NAME'], 'login.php') == true) :?>
          ...
          <?php elseif($_SESSION['active']==true) :?>
            <div class="form-ctrl__wrapper">
              <input onclick="alert('not implemented!');" type="button" value="+ New" class="form-ctrl form-submit"/>
            </div>
            <div class="form-ctrl__wrapper">
